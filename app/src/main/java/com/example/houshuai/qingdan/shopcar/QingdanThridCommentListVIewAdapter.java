...
public class QingdanThridCommentListVIewAdapter extends BaseAdapter {
    private Context context;
    @SuppressWarnings("unused")
    private ArrayList<HashMap<String, Object>> arrayList;

    @SuppressWarnings("unchecked")
    public QingdanThridCommentListVIewAdapter(Context context,HashMap<String, Object> hashmap){

        this.context=context;
        this.arrayList=(ArrayList<HashMap<String, Object>>) hashmap.get("data");
    }

    public QingdanThridCommentListVIewAdapter(Context context){
        this.context=context;
