...
public class Qingdan_list_Adapter2 extends BaseAdapter {


    private Activity activity;
    private List<CategoryListBean.MzMartshowsBean> list;
    private  ViewHolder vh=null;

    public Qingdan_list_Adapter2(List<CategoryListBean.MzMartshowsBean> list, Activity activity) {
    ...
    public void reloadData(List<CategoryListBean.MzMartshowsBean> data , boolean isClear) {
        if (list != null) {
            if (isClear) {
                list.clear();
            }
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView==null)
        {
           ...
           vh= (ViewHolder) convertView.getTag();
            ...
            vh.discountTv.setText( list.get(i).getMin_discount()/10+"折起");
