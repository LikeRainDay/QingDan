...
public class AllBaby_F extends Fragment implements IBtnCallListener, Adapter_ListView_cart.onCheckedChanged, OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        is_choice=new boolean[QingdanShopingCarData.arrayList_cart.size()];
    ...
    private void initView(View view) {
        ...
        cb_cart_all.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
                ...
                if (arg1) {
                    // 设置全选
                    for (int i = 0; i < QingdanShopingCarData.arrayList_cart.size(); i++) {
                    ...
                    if (isChoice_all == QingdanShopingCarData.arrayList_cart.size()) {
        ...
        if (QingdanShopingCarData.arrayList_cart != null && QingdanShopingCarData.arrayList_cart.size() != 0) {
            adapter = new Adapter_ListView_cart(getActivity(), QingdanShopingCarData.arrayList_cart);
        ...
        listView_cart.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent intent = new Intent(getActivity(), QingdanThridActivity.class);
    ...
    public void getChoiceData(int position, boolean isChoice) {
        ...
        if (num_choice == QingdanShopingCarData.arrayList_cart.size()) {
        ...
        tv_cart_Allprice.setText("合计：￥"+QingdanShopingCarData.Allprice_cart + "");
                ...
                if (tv_cart_buy_Ordel.getText().toString().equals("删除")) {
                    ...
                    if (QingdanShopingCarData.arrayList_cart.size()!=0) {
                        for (int i = is_choice_copy.length-1; i >=0; i--) {
                            if (is_choice_copy[i]) {
                                ((CheckBox) (listView_cart.getChildAt(i)).findViewById(R.id.cb_choice)).setChecked(false);
                                QingdanShopingCarData.arrayList_cart.remove(i);
                    ...
                    //执行结算操作
                    if (QingdanShopingCarData.Allprice_cart>=0){
                        tv_cart_buy_Ordel.setOnClickListener(new OnClickListener() {
                            @Override
                            public void onClick(View view) {
                            Toast.makeText(getActivity(),"支付页面",Toast.LENGTH_SHORT).show();
                            }
                        });


                    }
                     else {Toast.makeText(getActivity(), "请选择要结算的商品", Toast.LENGTH_SHORT).show();}
